package com.example.eatathome.Client.Activities.Helper;
...
public class RecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        if (viewHolder instanceof com.example.eatathome.Client.Activities.ViewHolder.CartViewHolder) {
            View foregroundView = ((com.example.eatathome.Client.Activities.ViewHolder.CartViewHolder) viewHolder).view_foreground;
