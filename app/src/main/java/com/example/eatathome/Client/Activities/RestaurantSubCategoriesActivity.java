...
public class RestaurantSubCategoriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent cartIntent = new Intent(RestaurantSubCategoriesActivity.this, CartActivity.class);
            ...
            protected void onBindViewHolder(@NonNull MenuViewHolder holder, int position, @NonNull Category model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        Intent foodList = new Intent(RestaurantSubCategoriesActivity.this, FoodListActivity.class);
