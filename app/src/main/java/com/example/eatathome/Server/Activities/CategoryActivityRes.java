...
public class CategoryActivityRes extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category = database.getReference("Restaurants").child("detail").child("Category");
...
/*
        ...
        adminName = headerView.findViewById(R.id.text_full_name);
        adminName.setText(Constant.restaurantUser.getName());*/
    ...
    private void showDialog() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(CategoryActivityRes.this);
        alertDialog.setTitle("Add Food Category");
        ...
        categoryName = add_category.findViewById(R.id.et_name_category);
        btnSelect = add_category.findViewById(R.id.btn_select);
        btnUpload = add_category.findViewById(R.id.btn_upload);
            ...
            imageFolder.putFile(saveUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            mDialog.dismiss();
                            Toast.makeText(CategoryActivityRes.this, "Uploaded!", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            mDialog.dismiss();
                            Toast.makeText(CategoryActivityRes.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            protected void onBindViewHolder(@NonNull MenuViewHolder holder, int position, @NonNull Category model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent foodList = new Intent(CategoryActivityRes.this, FoodListActivityRes.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu) {
            ...
            Intent order = new Intent(CategoryActivityRes.this, OrderStatusActivityRes.class);
            startActivity(order);
