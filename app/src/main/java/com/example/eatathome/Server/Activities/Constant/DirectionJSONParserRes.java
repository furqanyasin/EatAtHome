package com.example.eatathome.Server.Activities.Constant;
        ...
        try {
            ...
            for (int i = 0; i < jRoutes.length(); i++) {
                ...
                for (int j = 0; j < jLegs.length(); j++) {
                    ...
                    ConstantRes.DISTANCE = String.valueOf(dist + " km ");
                    ConstantRes.DURATION = String.valueOf(hours + " hours " + minutes + " mins " + seconds + " seconds ");
                    ...
                    ConstantRes.ESTIMATED_TIME = String.valueOf(DBFormat.format(calendar.getTime()));
                }
            }
