...
import com.example.eatathome.Models.Category;
import com.example.eatathome.ViewHolder.MenuViewHolder;
...
public class HomeActivityRes extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category = database.getReference("Restaurants").child(Constant.restaurantUser.getRestaurantId()).child("detail").child("Category");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu) {
            ...
            Intent order = new Intent(HomeActivityRes.this, OrderStatusActivityRes.class);
            startActivity(order);
