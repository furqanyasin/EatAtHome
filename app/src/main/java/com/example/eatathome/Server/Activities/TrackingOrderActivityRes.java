...
import com.example.eatathome.Constant.DirectionJSONParser;
...
public class TrackingOrderActivityRes extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tracking_order_res);
    ...
    private void displayLocation() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            if (mLastLocation != null) {
                ...
                drawRoute(yourLocation,Constant.currentRequest.getAddress());
            } else {
        ...
        mServices.getGeoCode(address).enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try {
                    ...
                    bitmap = Constant.scaleBitmap(bitmap,60,60);
                    MarkerOptions marker = new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(bitmap))
                            .title("order of "+ Constant.currentRequest.getPhone())
                    ...
                    mServices.getDirections(yourLocation.latitude+","+yourLocation.longitude,
                            ...
                            .enqueue(new Callback<String>() {
                                @Override
                                public void onResponse(Call<String> call, Response<String> response) {
                                    new PaerserTask().execute(response.body().toString());
                                }
    ...
    private boolean checkPlayServices() {
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            if (GooglePlayServicesUtil.isUserRecoverableError(resultCode)) {
                ...
                Toast.makeText(this, "This devices not supported", Toast.LENGTH_SHORT).show();
                finish();
            }
            return false;
        }
    ...
    private class PaerserTask extends AsyncTask<String,Integer, List<List<HashMap<String,String>>>> {
